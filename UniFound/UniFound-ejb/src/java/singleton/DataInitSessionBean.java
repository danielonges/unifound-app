...
//            initialiseMessage(3L, 1L, 3L);
    ...
    public void initialiseLostFound() {
        try {
            ...
            lostFoundSessionBeanLocal.createLostFound(new LostFoundListing("Wallet", "Last seen at YIH", "YIH", "Please help!", "lost", "Wallet"), new Long(2));
            lostFoundSessionBeanLocal.createLostFound(new LostFoundListing("Canvas bag", "Found a bag", "COM1", "Chat me if it's yours", "found", "Bag"), new Long(3));
